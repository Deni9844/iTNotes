...
const QuestionCard = ({ item,ansToggleHandler,index}) => {

  return (
    <div className='qtns-card' onClick={()=>ansToggleHandler(index)}>
      <p className='qtn'>{item.qtns}</p>
      {
        item.askedOn && 
      <div className='year'>      
        ...
        <p>Asked on {item.askedOn} Exam</p>
      </div>
      }
